# ENUNCIADO:
#       1) Desenvolva uma aplicação com OpenGL, com base no Ex1 - Renderização de um triângulo, com os seguintes requisitos:
#       
#          = Modifique a modelagem do objeto, de modo que hajam um triângulo equilátero (já existente), um triângulo retângulo e um quadrado, todos no mesmo VAO.
#          = Modifique os shaders, de modo que as posições finais sejam espelhadas em x e y, e as cores sejam invertidas (negativadas).
#
# ========================================================================================================================================================================
...
def inicializaShaders():
    ...
    vertex_shader = """
        ...
        out vec3 cores;
        void main () {
            cores = vec3(1, 1, 1) - vertex_cores;
            gl_Position = vec4 (vertex_posicao * -1, 1.0); 
        }
    """
