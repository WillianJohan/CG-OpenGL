...
# ENUNCIADO:
#       2) Desenvolva uma aplicação com OpenGL, com base no Ex1 - Renderização de um triângulo, de modo que, 
#          nos shaders, a posição dos vértices seja utilizada como cor dos vértices. Você precisará passar a 
#          posição dos vértices do vertex shader para o fragment shader.
#       
# ========================================================================================================================================================================
...
def inicializaShaders():
    ...
    vertex_shader = """
        ...
        out vec3 vertex_Colour; //Irá passar para o fragment Shader o valor da posição do vertice para ser usado como Cor.
        void main () {
            vertex_Colour = vertex_posicao;
    ...
    fragment_shader = """
        #version 400
        in vec3 vertex_Colour; //Irá receber os valores referente a cor dos vertices.
